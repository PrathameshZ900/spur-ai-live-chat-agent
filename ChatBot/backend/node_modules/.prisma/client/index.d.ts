...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      UserMemory: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.UserMemoryFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.UserMemoryAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserMemoryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "conversationId" | "key" | "value" | "createdAt" | "updatedAt", ExtArgs["result"]["userMemory"]>
  ...
  export interface UserMemoryDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more UserMemories that matches the filter.
     * @param {UserMemoryFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const userMemory = await prisma.userMemory.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: UserMemoryFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a UserMemory.
     * @param {UserMemoryAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const userMemory = await prisma.userMemory.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: UserMemoryAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
   ...
   * UserMemory findRaw
   */
  export type UserMemoryFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * UserMemory aggregateRaw
   */
  export type UserMemoryAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type UserMemoryWhereUniqueInput = Prisma.AtLeast<{
    id?: string
    conversationId_key?: UserMemoryConversationIdKeyCompoundUniqueInput
    AND?: UserMemoryWhereInput | UserMemoryWhereInput[]
    OR?: UserMemoryWhereInput[]
    NOT?: UserMemoryWhereInput | UserMemoryWhereInput[]
    conversationId?: StringFilter<"UserMemory"> | string
  ...
  export type UserMemoryConversationIdKeyCompoundUniqueInput = {
    conversationId: string
    key: string
  }
